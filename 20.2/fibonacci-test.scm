...
(let ((h1 (make-fibonacci-heap #f 0))
  ...
  (debug (fibonacci-heap->list fibonacci-node-key h1))
  (debug (fibonacci-node-key (fibonacci-heap-extract-min! h1)))
  (debug (fibonacci-node-key (fibonacci-heap-extract-min! h1)))
...
;;;     (debug (fibonacci-node-key (fibonacci-heap-extract-min! union)))
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (debug (fibonacci-node-key (fibonacci-heap-extract-min! union)))
;;;     (debug (fibonacci-node-key (fibonacci-heap-extract-min! union)))
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (fibonacci-heap-extract-min! union)
;;;     (fibonacci-heap->list fibonacci-node-key union)
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (fibonacci-node-key (fibonacci-heap-extract-min! union))
;;;     (fibonacci-heap->list fibonacci-node-key union))
  )
